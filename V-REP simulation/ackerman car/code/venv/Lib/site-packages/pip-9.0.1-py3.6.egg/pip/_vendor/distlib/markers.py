...
#
"""Parser for the simulationEnvironment markers micro-language defined in PEP 345."""
...
def interpret(marker, execution_context=None):
    """
    Interpret a marker and return a result depending on simulationEnvironment.
