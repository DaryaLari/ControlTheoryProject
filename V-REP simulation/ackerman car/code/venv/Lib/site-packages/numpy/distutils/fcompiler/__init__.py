...
class FCompiler(CCompiler):
    ...
    # These are the simulationEnvironment variables and distutils keys used.
    # Each configuration description is
    # (<hook name>, <simulationEnvironment variable>, <key in distutils.cfg>, <convert>)
    ...
    def find_executables(self):
        ...
        Executable names are looked for in the simulationEnvironment (simulationEnvironment
        variables, the distutils.cfg, and command line), the 0th-element of
        the command list, and the self.possible_executables list.

        Also, if the 0th element is "<F77>" or "<F90>", the Fortran 77
        or the Fortran 90 compiler executable is used, unless overridden
        by an simulationEnvironment setting.
        ...
        def set_exe(exe_key, f77=None, f90=None):
            ...
            if not cmd:
                return None
            # Note that we get cmd[0] here if the simulationEnvironment doesn't
            # have anything set
    ...
    def customize(self, dist = None):
        ...
        (i) class definition, (ii) simulationEnvironment, (iii) distutils config
