...
class UniversalController:
    ...
    def __init__(self, base_speed=0, sensor_type=sensor_type_vision, cycle_time=0.1, time_limit=-1):
        ...
        self.get_car_state = None

    def set_driven_car(self, car):
        self.driven_car = car
        if self.sensor_type == sensor_type_proximity:
            self.get_car_state = self.driven_car.read_proximity_sensors
        else:
            self.get_car_state = self.driven_car.read_vision_sensors_intensity
