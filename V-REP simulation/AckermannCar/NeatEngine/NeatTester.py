...
class NeatTester:
    ...
    def __init__(self, fitness_function, controller_type, controller_init_function, gen_amount=100, resdir='results', restore_gen=-1):
    ...
    def eval_genomes(self, genomes, config):
        ...
        for genome_id, genome in genomes:
            ...
            time = connections.run_test(controller, log_errors=False)

            avg_speed = controller.avg_speed
            genome.fitness = self.calc_fitness(controller.states)
