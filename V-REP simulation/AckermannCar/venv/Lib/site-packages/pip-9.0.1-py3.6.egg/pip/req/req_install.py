...
class InstallRequirement(object):
    ...
    def uninstall(self, auto_confirm=False):
        ...
        thus uninstallation within a virtual simulationEnvironment can only
        modify that virtual simulationEnvironment, even if the virtualenv is
        ...
        if not dist_is_local(dist):
            logger.info(
                "Not uninstalling %s at %s, outside simulationEnvironment %s",
                dist.key,
                dist_path,
                sys.prefix,
            )
